...
| **3.5.1** | **2026-09-13** | **Hardened Source Admission with mandatory doctor/cross-validation/approval evidence, completed the authorized Vietstock response-path contract, and removed CafeF parser dependency ambiguity. Status remains offline-only.** |
