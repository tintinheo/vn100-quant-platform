...
| **3.5.1** | **2026-09-13** | **Provider registry now models DOCTOR_PASSED and CROSS_VALIDATED and requires immutable admission evidence; Vietstock record envelopes are contract-mapped and CafeF HTML uses a standard-library fail-closed parser.** |
