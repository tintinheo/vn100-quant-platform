...
**Business Requirements Document · v3.5 SSI-Free DNSE-First Auto-Sync Baseline · Bản tiếng Việt**

| | |
|---|---|
| Phiên bản | **3.5 SSI-FREE DNSE-FIRST AUTO-SYNC BASELINE — 2026-09-13** |
| Thay thế | `BRD-VN100-Quant-Platform-v3.4-AUTO-REFRESH-MULTI-SOURCE-VI.md` |
| Tài liệu đi kèm | `SRD — VN100 Quant Platform` |
| Nguồn hợp nhất | baseline v3.4 auto-refresh + research DNSE OpenAPI/CafeF/Vietstock ngày 2026-09-13 + module multi-source VN100 đã offline-test |
| Trạng thái v3.5 | **Luồng bình thường vẫn AUTO-SYNC và không dùng SSI. Research mới xác minh DNSE OpenAPI có market-data API documented, Python SDK chính thức, REST OHLC/instruments/foreign data và WebSocket market data. Vì vậy DNSE trở thành automated market-data candidate hàng đầu `[GUESS]`, nhưng CHƯA ADMITTED cho đến khi live validation credentials/schema/index-filter/rate-limit pass. Module `vn100_multisource_feed_v1` đã IMPLEMENTED + OFFLINE TESTED (10/10), gồm DNSE primary adapter, SQLite incremental cache, CafeF reference parser opt-in và Vietstock DataFeed adapter dạng contract-gated. Chưa có claim real-data validation.** |
