...
| **3.5.1** | **2026-09-13** | **Siết Source Admission bằng evidence bắt buộc cho doctor/cross-validation/approval, hoàn chỉnh Vietstock response-path contract được ủy quyền, và loại bỏ phụ thuộc parser không rõ ràng của CafeF. Trạng thái vẫn chỉ offline.** |
